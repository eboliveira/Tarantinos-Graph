...
if (typeof janrain.settings.common.appUrl === 'undefined')janrain.settings.common.appUrl = "https://signin.ifc.com";
...
if (typeof janrain.settings.width === 'undefined')janrain.settings.width = "217";
...
if (typeof janrain.settings.appId === 'undefined')janrain.settings.appId = "miioicfamnlhljdjdden";
if (typeof janrain.settings.appUrl === 'undefined')janrain.settings.appUrl = "https://signin.ifc.com";
janrain.settings.permissions = ["customizable_auth_widget_hide_attribution","customizable_auth_widget_styling"];
if (typeof janrain.settings.providers === 'undefined')janrain.settings.providers = ["facebook","twitter","googleplus"];
if (typeof janrain.settings.noReturnExperience === 'undefined')janrain.settings.noReturnExperience = false;
if (typeof janrain.settings.facebookAppId === 'undefined')janrain.settings.facebookAppId = "427919150728750";
...
if (typeof janrain.settings.share.appUrl === 'undefined')janrain.settings.share.appUrl = "https://signin.ifc.com";
...
function getPackagePath(packages) {
    ...
    var path = rootPath + 'manifest/' + packages.join(':') + '?version=' + encodeURIComponent('release/1.117.4_widgets_1136');
    return path;
}
